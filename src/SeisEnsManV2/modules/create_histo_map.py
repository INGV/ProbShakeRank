...
def create_histo_map(**kwargs):
   ...
   destination_folder = os.path.abspath(os.path.join(os.getcwd(), f"../../INPUT_FILES/events/{ename}"))
   ...
   print(f"############# Copied parameters_histo_map_{str(ename)}.pdf to INPUT_FILES/events/{ename}#############")
