...
#                  'Example for rabbit connetion mode:\n'  + sys.argv[0] + ' --cfg cfg/ptf_main.config --mode rabbit' + '\n  '
    ...
    parser.add_argument('--ev_id',             default=None,          help = 'Event ID')
    ...
    parser.add_argument('--nb_scen',           default = None,        help = 'Number of scenarios. Default = 100')
    parser.add_argument('--event',             default = None,        help = 'seismic event parameter file. Default = None')
    parser.add_argument('--event_ingv',        default = '../IO/earlyEst/default.json',        help = 'seismic event default file. Default = None')
